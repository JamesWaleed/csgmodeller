...
// see the various methods below on how to change these
  this.camera = {
    ...
    position: {x:   0,y:  0,z:  400},  // initial position at XYZ
  ...
  this.axis = {
    draw: false,                // draw or not
    x: {
      neg: {r: 1, g: 1, b: 1, a: .5}, // color in negative direction
...
OpenJsCad.Processor.prototype = {
  createElements: function() {
    ...
    this.parametersdiv = this.containerdiv.parentElement.querySelector("div#mydiv");
    if (!this.parametersdiv) {
      this.parametersdiv = document.createElement("div");
      this.parametersdiv.id = "mydiv";
  ...
  getParamValues: function()
  {
	...
	// document.getElementById("width").innerHTML = paramValues.width;
	// document.getElementById("wheelbase").innerHTML = paramValues.wheelbase;
	// document.getElementById("concaveDrop").innerHTML = paramValues.concave_drop;
	// document.getElementById("noseLength").innerHTML = paramValues.nose_length;
	// document.getElementById("tailLength").innerHTML = paramValues.tail_length;
	// document.getElementById("noseAngle").innerHTML = paramValues.kicknose_angle;
	// document.getElementById("tailAngle").innerHTML = paramValues.kicktail_angle;
	// document.getElementById("noseFlatness").innerHTML = paramValues.nose_flatness;
	// document.getElementById("tailFlatness").innerHTML = paramValues.tail_flatness;
	// document.getElementById("noseRadius").innerHTML = paramValues.nose_radius;
	// document.getElementById("tailRadius").innerHTML = paramValues.tail_radius;
	// var boardLength = paramValues.wheelbase + paramValues.nose_length + paramValues.tail_length + 4.25;
	// document.getElementById("boardlength").innerHTML = boardLength;
	/*if (boardLength > 33) {
		document.getElementById("boardlength").innerHTML = "<p style='color:red'>Board length = <strong>" + boardLength + "</strong> (max board length is 33 inches)</p><p>For longer boards, please <a href='http://www.opensourceboards.com/contact' target='_blank'>contact us</a> directly for a quote</p>";
	}*/
    return paramValues;
  },
  ...
  createParamControls: function() {
    ...
    // add the appropriate element to the table
      ...
      if(type == "group") {
        ...
        var td = document.createElement("h3");
